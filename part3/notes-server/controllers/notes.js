...
console.log(Note, "note from controller");
...
app.delete("/:id", async (request, response) => {
  console.log(typeof Note.findByIdAndDelete(), "in delete");

  const responsedelete = Note.findByIdAndDelete(request.params.id);
  console.log("the delte", responsedelete);
